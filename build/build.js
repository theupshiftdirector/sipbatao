...
<section class="calc-cta">
    ...
    const guideCtaText = pageData.ctaText || 'Open Calculator';
...
<section class="calc-cta">
    <div class="calc-cta-box">
        <h3>${guideCtaText}</h3>
        <p>Use our free SIP calculator to see how your investments grow over time with the power of compounding.</p>
